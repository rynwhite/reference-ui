...
export const Abbr = forwardRef<PrimitiveElement<'abbr'>, PrimitiveProps<'abbr'>>((props, ref) => <styled.abbr ref={ref} {...applyBoxPattern(props, abbrStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'abbr'> & React.RefAttributes<PrimitiveElement<'abbr'>>>
...
export const B = forwardRef<PrimitiveElement<'b'>, PrimitiveProps<'b'>>((props, ref) => <styled.b ref={ref} {...applyBoxPattern(props, bStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'b'> & React.RefAttributes<PrimitiveElement<'b'>>>
...
export const Blockquote = forwardRef<PrimitiveElement<'blockquote'>, PrimitiveProps<'blockquote'>>((props, ref) => <styled.blockquote ref={ref} {...applyBoxPattern(props, blockquoteStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'blockquote'> & React.RefAttributes<PrimitiveElement<'blockquote'>>>
...
export const Cite = forwardRef<PrimitiveElement<'cite'>, PrimitiveProps<'cite'>>((props, ref) => <styled.cite ref={ref} {...applyBoxPattern(props, citeStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'cite'> & React.RefAttributes<PrimitiveElement<'cite'>>>
export const Code = forwardRef<PrimitiveElement<'code'>, PrimitiveProps<'code'>>((props, ref) => <styled.code ref={ref} {...applyBoxPattern(props, codeStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'code'> & React.RefAttributes<PrimitiveElement<'code'>>>
...
export const Em = forwardRef<PrimitiveElement<'em'>, PrimitiveProps<'em'>>((props, ref) => <styled.em ref={ref} {...applyBoxPattern(props, emStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'em'> & React.RefAttributes<PrimitiveElement<'em'>>>
...
export const H1 = forwardRef<PrimitiveElement<'h1'>, PrimitiveProps<'h1'>>((props, ref) => <styled.h1 ref={ref} {...applyBoxPattern(props, h1Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h1'> & React.RefAttributes<PrimitiveElement<'h1'>>>
export const H2 = forwardRef<PrimitiveElement<'h2'>, PrimitiveProps<'h2'>>((props, ref) => <styled.h2 ref={ref} {...applyBoxPattern(props, h2Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h2'> & React.RefAttributes<PrimitiveElement<'h2'>>>
export const H3 = forwardRef<PrimitiveElement<'h3'>, PrimitiveProps<'h3'>>((props, ref) => <styled.h3 ref={ref} {...applyBoxPattern(props, h3Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h3'> & React.RefAttributes<PrimitiveElement<'h3'>>>
export const H4 = forwardRef<PrimitiveElement<'h4'>, PrimitiveProps<'h4'>>((props, ref) => <styled.h4 ref={ref} {...applyBoxPattern(props, h4Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h4'> & React.RefAttributes<PrimitiveElement<'h4'>>>
export const H5 = forwardRef<PrimitiveElement<'h5'>, PrimitiveProps<'h5'>>((props, ref) => <styled.h5 ref={ref} {...applyBoxPattern(props, h5Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h5'> & React.RefAttributes<PrimitiveElement<'h5'>>>
export const H6 = forwardRef<PrimitiveElement<'h6'>, PrimitiveProps<'h6'>>((props, ref) => <styled.h6 ref={ref} {...applyBoxPattern(props, h6Style())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'h6'> & React.RefAttributes<PrimitiveElement<'h6'>>>
...
export const I = forwardRef<PrimitiveElement<'i'>, PrimitiveProps<'i'>>((props, ref) => <styled.i ref={ref} {...applyBoxPattern(props, iStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'i'> & React.RefAttributes<PrimitiveElement<'i'>>>
...
export const Kbd = forwardRef<PrimitiveElement<'kbd'>, PrimitiveProps<'kbd'>>((props, ref) => <styled.kbd ref={ref} {...applyBoxPattern(props, kbdStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'kbd'> & React.RefAttributes<PrimitiveElement<'kbd'>>>
...
export const Mark = forwardRef<PrimitiveElement<'mark'>, PrimitiveProps<'mark'>>((props, ref) => <styled.mark ref={ref} {...applyBoxPattern(props, markStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'mark'> & React.RefAttributes<PrimitiveElement<'mark'>>>
...
export const P = forwardRef<PrimitiveElement<'p'>, PrimitiveProps<'p'>>((props, ref) => <styled.p ref={ref} {...applyBoxPattern(props, pStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'p'> & React.RefAttributes<PrimitiveElement<'p'>>>
...
export const Pre = forwardRef<PrimitiveElement<'pre'>, PrimitiveProps<'pre'>>((props, ref) => <styled.pre ref={ref} {...applyBoxPattern(props, preStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'pre'> & React.RefAttributes<PrimitiveElement<'pre'>>>
...
export const Q = forwardRef<PrimitiveElement<'q'>, PrimitiveProps<'q'>>((props, ref) => <styled.q ref={ref} {...applyBoxPattern(props, qStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'q'> & React.RefAttributes<PrimitiveElement<'q'>>>
...
export const S = forwardRef<PrimitiveElement<'s'>, PrimitiveProps<'s'>>((props, ref) => <styled.s ref={ref} {...applyBoxPattern(props, sStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'s'> & React.RefAttributes<PrimitiveElement<'s'>>>
export const Samp = forwardRef<PrimitiveElement<'samp'>, PrimitiveProps<'samp'>>((props, ref) => <styled.samp ref={ref} {...applyBoxPattern(props, sampStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'samp'> & React.RefAttributes<PrimitiveElement<'samp'>>>
...
export const Small = forwardRef<PrimitiveElement<'small'>, PrimitiveProps<'small'>>((props, ref) => <styled.small ref={ref} {...applyBoxPattern(props, smallStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'small'> & React.RefAttributes<PrimitiveElement<'small'>>>
...
export const Strong = forwardRef<PrimitiveElement<'strong'>, PrimitiveProps<'strong'>>((props, ref) => <styled.strong ref={ref} {...applyBoxPattern(props, strongStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'strong'> & React.RefAttributes<PrimitiveElement<'strong'>>>
export const Sub = forwardRef<PrimitiveElement<'sub'>, PrimitiveProps<'sub'>>((props, ref) => <styled.sub ref={ref} {...applyBoxPattern(props, subStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'sub'> & React.RefAttributes<PrimitiveElement<'sub'>>>
...
export const Sup = forwardRef<PrimitiveElement<'sup'>, PrimitiveProps<'sup'>>((props, ref) => <styled.sup ref={ref} {...applyBoxPattern(props, supStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'sup'> & React.RefAttributes<PrimitiveElement<'sup'>>>
...
export const U = forwardRef<PrimitiveElement<'u'>, PrimitiveProps<'u'>>((props, ref) => <styled.u ref={ref} {...applyBoxPattern(props, uStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'u'> & React.RefAttributes<PrimitiveElement<'u'>>>
...
export const Var = forwardRef<PrimitiveElement<'var'>, PrimitiveProps<'var'>>((props, ref) => <styled.var ref={ref} {...applyBoxPattern(props, varStyle())} />) as React.ForwardRefExoticComponent<PrimitiveProps<'var'> & React.RefAttributes<PrimitiveElement<'var'>>>
